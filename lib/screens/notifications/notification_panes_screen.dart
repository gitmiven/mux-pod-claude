...
/// Notification panes list screen (based on tmux activity/bell/silence flags)
...
class _NotificationPanesScreenState extends ConsumerState<NotificationPanesScreen> {
  ...
  Future<void> _openAlertPane(AlertPane alert) async {
    ...
    // Remove alerts from the same window from the local list
    ...
    // Clear the window flag on the tmux side (background)
  ...
  void _dismissAlert(AlertPane alert) {
    ...
    // Also clear the flag on the tmux side
    notifier.clearWindowFlag(alert);
  }
