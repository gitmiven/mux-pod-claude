...
class HomeScreen extends ConsumerWidget {
      ...
      child: SafeArea(
        child: SizedBox(
          ...
          child: Stack(
            ...
            children: [
              // Standard navigation items (5 evenly spaced)
              Row(
                ...
                children: [
                  ...
                  // Center spacer (Dashboard button area)
  ...
  /// Center Dashboard button (large, protruding)
...
/// Terminal tab - displays active sessions list
...
class _TerminalTabState extends ConsumerState<_TerminalTab> {
  ...
  Widget build(BuildContext context) {
    ...
    // Display only sessions that are connected (isAttached == true)
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        ...
                        // Display last opened pane information
