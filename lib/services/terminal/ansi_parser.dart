...
///
/// Parser for converting the output of capture-pane -e (ANSI color text)
/// to TextSpan.
class AnsiParser {
  ...
  TextSpan toTextSpan(
    ...
    return TextSpan(
      children: segments.map((segment) {
        ...
        // Spaces in inverse mode may not render background color, so replace with no-break space
  ...
  ///
  /// Parse each line individually and carry the style over to the next line.
  /// The returned list of [ParsedLine] is used for line-by-line rendering in virtual scrolling.
