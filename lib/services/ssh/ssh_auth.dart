...
enum BiometricAuthResult {
  ...
  /// Locked out (max attempts exceeded)
  lockedOut,
...
///
/// Manages authentication credentials and provides biometric authentication.
class SshAuthService {
  ...
  /// Get authentication credentials for a connection
  ///
  ...
  /// Authentication (biometric or device PIN/pattern)
  ///
  ...
  BiometricAuthResult _handleAuthError(PlatformException e) {
    // Returns result based on local_auth error codes
    final code = e.code;
  ...
  // ===== Bulk operations on connection credentials =====
