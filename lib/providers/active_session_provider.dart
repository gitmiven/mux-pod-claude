...
class ActiveSession {
  ...
  /// Last accessed date/time (for history sorting)
...
class ActiveSessionsState {
  ...
  /// Get sessions list for specified connection
...
/// Notifier for managing active sessions
class ActiveSessionsNotifier extends Notifier<ActiveSessionsState> {
  ...
  Future<void> _loadFromStorage() async {
    try {
      ...
      // Ignore load errors (on first startup, etc.)
    }
  }
  ...
  /// Update last opened pane information for session
  void updateLastPane({
    required String connectionId,
    required String sessionName,
  ...
  /// Update last accessed date/time when session is opened
  ...
  /// Update sessions list for connection (from tmux sessions list)
  /// Preserve lastWindowIndex/lastPaneId/lastAccessedAt of existing sessions
  void updateSessionsForConnection({
    ...
    // Save existing session information to map
  ...
  /// Explicitly close (delete) session
